...
import { loggingEnabled } from "./internal/room-logger.js";
...
// Re-export lifecycle symbols for backward compatibility during transition
export {
	clearIdleCompletionTimeout,
	listRooms,
	getRoom,
...
export { spawnAndSendToSingleShot };
