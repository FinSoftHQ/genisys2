...
<CRITICAL_CONSTRAINTS>
  ...
  <Constraint name="Type-Safety & Contract">
    ...
    - Never modify `src/libs/shared/` directly. If a schema is missing or incorrect, note it in your output so the Team Lead can route it to the Architect. Do not work around it.
  </Constraint>
